...
namespace PetPlay
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			Console.WriteLine("Obrigada por utilizar os serviços da PetPlay");
			Console.ReadLine();
        }
		...
		{
			Console.WriteLine();
			Console.WriteLine("PetPlay, as melhores séries sobres os pets mais fofos do Mundo estão aqui!!");
			Console.WriteLine();
